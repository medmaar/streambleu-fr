...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Politique de remboursement", "item": "https://streambleu.fr/politique-remboursement"}
  ]
};
        ...
        <div className="space-y-10 leading-relaxed" style={{ color: "#333" }}>
          ...
          <section>
            ...
            <div style={{ background: "rgba(90,95,207,0.06)", borderRadius: 12, padding: 24, border: "1px solid rgba(90,95,207,0.15)" }}>
              <p><span style={{ color: "#5a5fcf", fontWeight: 600 }}>WhatsApp : </span><a href="/discuter/wa" target="_blank" rel="noopener noreferrer" style={{ color: "#5a5fcf" }}>WhatsApp</a></p>
