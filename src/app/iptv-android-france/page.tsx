...
export const metadata: Metadata = {
  ...
  description:
    "Comment regarder Stream Bleu sur Android (Téléphone) en France. Guide complet. 25 000+ chaînes, 4K Ultra HD. Compatible Samsung Galaxy, Google Pixel, OnePlus, Xiaomi.",
  ...
  openGraph: {
    title: "IPTV sur Android (Téléphone) en France 2026 | Stream Bleu",
    description: "Installez Stream Bleu sur Android (Téléphone) en France. Guide étape par étape.",
    url: "https://streambleu.fr/iptv-android-france",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Android (Téléphone)" }],
  },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV sur Android (Téléphone) en France 2026", "item": "https://streambleu.fr/iptv-android-france"}
  ]
};
export default function IPTVAndroidFrancePage() {
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "clamp(14px, 2vw, 17px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
            Guide complet pour configurer Stream Bleu sur votre Android (Téléphone). Installation en 5 minutes, 25 000+ chaînes françaises et internationales en 4K Ultra HD.
          </p>
      ...
      <section style={{ padding: "48px 24px", background: "transparent" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", background: "#5a5fcf", borderRadius: 24, padding: "48px 40px", textAlign: "center", boxShadow: "0 12px 40px rgba(90,95,207,0.3)" }}>
          <h2 style={{ fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 900, color: "#fff", marginBottom: 14 }}>
            IPTV sur Android (Téléphone) à partir de 9€/mois
          </h2>
