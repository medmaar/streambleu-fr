...
export const metadata: Metadata = {
  ...
  description:
    "Stream Bleu est le meilleur service IPTV à Marseille. Regardez TF1, Canal+, beIN Sports, RMC Sport et 50 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Stream Bleu est le meilleur service IPTV à Marseille. 50 000+ chaînes, 300 000+ films et séries en 4K. À partir de 9€/mois.",
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Stream Bleu est largement considéré comme le meilleur service IPTV à Marseille. Il propose 50 000+ chaînes en direct incluant toutes les chaînes locales françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 300 000+ titres à la demande — à partir de 9€/mois.",
  },
  {
        ...
        <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              ...
              RMC Sport et 50 000+ chaînes en 4K Ultra HD. Suivez l'OM, la Ligue 1 et la Champions League en 4K Ultra HD sans coupure.
            </p>
