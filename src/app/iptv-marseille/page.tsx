...
export const metadata: Metadata = {
  title: { absolute: "IPTV Marseille 2026 | Stream Bleu — Meilleur IPTV France" },
  description:
    "Stream Bleu est le meilleur service IPTV à Marseille. Regardez TF1, Canal+, beIN Sports, RMC Sport et 25 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  keywords:
    "iptv marseille, meilleur iptv marseille, abonnement iptv Marseille, iptv france Marseille, stream bleu Marseille",
  alternates: { canonical: "https://streambleu.fr/iptv-marseille" },
  openGraph: {
    title: "IPTV Marseille 2026 | Stream Bleu — Meilleur IPTV France",
    description:
      "Stream Bleu est le meilleur service IPTV à Marseille. 25 000+ chaînes, 120 000+ films et séries en 4K. À partir de 9€/mois.",
    url: "https://streambleu.fr/iptv-marseille",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Marseille" }],
  },
...
const faqItems = [
  {
    q: "L'IPTV est-il légal à Marseille ?",
    a: "La technologie IPTV est légale à Marseille et dans toute la France. Stream Bleu diffuse des flux internet sur votre appareil. Les utilisateurs à Marseille sont responsables de s'assurer que les contenus auxquels ils accèdent respectent la législation française sur le droit d'auteur.",
  },
  {
    q: "Quel est le meilleur service IPTV à Marseille ?",
    a: "Stream Bleu est largement considéré comme le meilleur service IPTV à Marseille. Il propose 25 000+ chaînes en direct incluant toutes les chaînes locales françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 120 000+ titres à la demande — à partir de 9€/mois.",
  },
  {
    q: "Stream Bleu fonctionne-t-il bien à Marseille ?",
    a: "Oui. Stream Bleu fonctionne parfaitement à Marseille avec n'importe quel fournisseur internet majeur comme Orange et Free. Nos serveurs sont optimisés pour les connexions en Provence-Alpes-Côte d'Azur, offrant des streams 4K stables avec un minimum de buffering même aux heures de pointe.",
  },
  {
    q: "Combien coûte un abonnement IPTV à Marseille ?",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV Marseille 2026", "item": "https://streambleu.fr/iptv-marseille"}
  ]
};
export default function IPTVMarseillePage() {
  return (
    <>
        ...
        <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <span style={{
              ...
              IPTV Marseille · Stream Bleu
            </span>
            <h1 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.1, marginTop: 24, marginBottom: 20, color: "#5a5fcf" }}>
              Meilleur IPTV<br />
              <span style={{ color: "#5a5fcf" }}>Marseille 2026</span>
            </h1>
            <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              Stream Bleu est le meilleur service IPTV à Marseille. Profitez de TF1, Canal+, beIN Sports,
              RMC Sport et 25 000+ chaînes en 4K Ultra HD. Suivez l'OM, la Ligue 1 et la Champions League en 4K Ultra HD sans coupure.
            </p>
        ...
        <section style={{ padding: "70px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 48, color: "#5a5fcf" }}>
              Pourquoi choisir Stream Bleu à Marseille ?
            </h2>
        ...
        <section style={{ padding: "48px 24px", background: "transparent" }}>
          <div style={{ maxWidth: 720, margin: "0 auto", background: "#5a5fcf", borderRadius: 24, padding: "48px 40px", textAlign: "center", boxShadow: "0 12px 40px rgba(90,95,207,0.3)" }}>
            <h2 style={{ fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, color: "#fff", marginBottom: 16 }}>
              Abonnement IPTV Marseille à partir de 9€/mois
            </h2>
        ...
        <section style={{ padding: "70px 16px", background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 40, color: "#5a5fcf" }}>
              Questions fréquentes — IPTV Marseille
            </h2>
        ...
        <section style={{ padding: "60px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center" }}>
              ...
              ].filter(c => !c.href.includes("marseille")).map((c) => (
