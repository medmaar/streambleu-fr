      ...
      <main style={{ background: "#E8F4F5", minHeight: "100vh" }}>
        ...
        <article style={{ maxWidth: 820, margin: "0 auto", padding: "60px 16px" }}>
          <section style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 24, fontWeight: 800, color: "#1A3D45", marginBottom: 14 }}>Ce dont vous avez besoin</h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                ...
                <div key={i} style={{ display: "flex", gap: 12, alignItems: "flex-start", background: "#fff", borderRadius: 10, padding: "14px 18px", border: "1px solid rgba(63,154,174,0.15)" }}>
                  <span style={{ color: "#3F9AAE", fontWeight: 800, fontSize: 16, flexShrink: 0 }}>✓</span>
          ...
          <section style={{ marginBottom: 48 }}>
            <h2 style={{ fontSize: 24, fontWeight: 800, color: "#1A3D45", marginBottom: 24 }}>Installation en 6 étapes</h2>
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {steps.map((step) => (
                <div key={step.num} style={{ background: "#fff", borderRadius: 16, padding: "24px 24px", border: "1px solid rgba(63,154,174,0.15)", display: "flex", gap: 20 }}>
                  <div style={{ flexShrink: 0, width: 44, height: 44, background: "#F96E5B", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 18, color: "#fff" }}>
                    {step.num}
                  </div>
                  <div>
                    <h3 style={{ fontWeight: 700, fontSize: 16, color: "#1A3D45", marginBottom: 8 }}>{step.title}</h3>
