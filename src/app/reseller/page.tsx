    ...
    <main style={{ background: "linear-gradient(135deg, #C9BEFF 0%, #FFDBFD 100%)", color: "#1a1a4e", minHeight: "100vh" }}>
      <section style={{ background: "#6367FF", padding: "80px 16px 60px", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, marginBottom: 20 }}>
            Lancez votre <span style={{ color: "#6367FF" }}>Business IPTV</span> en France
          </h1>
          ...
          <a href="mailto:help@streambleu.fr?subject=Demande Revendeur Stream Bleu"
            style={{ display: "inline-block", background: "#6367FF", color: "#fff", padding: "14px 36px", borderRadius: 14, fontWeight: 700, fontSize: 16, textDecoration: "none" }}>
            Devenir Revendeur →
          </a>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 16px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ textAlign: "center", fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 900, color: "#6367FF", marginBottom: 48 }}>
            Pourquoi revendre Stream Bleu ?
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
            {features.map((f) => (
              <div key={f.title} style={{ background: "#fff", borderRadius: 20, padding: "32px 28px", border: "1px solid rgba(132,148,255,0.15)", boxShadow: "0 4px 20px rgba(99,103,255,0.06)" }}>
                <div style={{ fontSize: 36, marginBottom: 16 }}>{f.icon}</div>
                <h3 style={{ fontWeight: 800, fontSize: 18, color: "#6367FF", marginBottom: 10 }}>{f.title}</h3>
        ...
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="mailto:help@streambleu.fr?subject=Demande Revendeur"
              style={{ display: "inline-block", background: "#6367FF", color: "#fff", padding: "14px 32px", borderRadius: 14, fontWeight: 700, fontSize: 15, textDecoration: "none" }}>
              Envoyer un Email
            </a>
