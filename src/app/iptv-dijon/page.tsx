...
export const metadata: Metadata = {
  title: { absolute: "IPTV Dijon 2026 | Stream | Meilleur IPTV Bourgogne-Franche-Comté" },
  ...
  openGraph: {
    ...
    description: "Stream Bleu est le meilleur service IPTV à Dijon. 50 000+ chaînes, 300 000+ films et séries en 4K. À partir de 9€/mois.",
...
const faqItems = [
  ...
  { q: "Quel est le meilleur service IPTV à Dijon ?", a: "Stream Bleu est le meilleur service IPTV à Dijon. Il propose 50 000+ chaînes en direct incluant toutes les chaînes françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 300 000+ titres à la demande — à partir de 9€/mois sans engagement." },
  ...
  { q: "Combien coûte un abonnement IPTV à Dijon ?", a: "Stream Bleu propose des abonnements à partir de 9€/mois sans engagement. Des forfaits longue durée permettent de descendre à 4€/mois. Toutes les formules incluent 50 000+ chaînes, 300 000+ films & séries, et les chaînes sportives premium." },
        ...
        <section style={{ padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "clamp(15px,2vw,18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              Stream Bleu est le meilleur service IPTV à Dijon. Profitez de TF1, Canal+, beIN Sports, RMC Sport et 50 000+ chaînes en 4K Ultra HD. Suivez le Dijon FCO et toutes les compétitions en 4K sans coupure.
            </p>
