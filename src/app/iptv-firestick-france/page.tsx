      ...
      <section style={{ padding: "60px 16px", background: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            <div style={{ background: "#FFDBFD", borderRadius: 14, padding: "20px 22px", border: "1px solid rgba(132,148,255,0.15)", display: "flex", gap: 16 }}><div style={{ flexShrink: 0, width: 40, height: 40, background: "#6367FF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, color: "#fff" }}>1</div><div><h3 style={{ fontWeight: 700, fontSize: 15, color: "#6367FF", marginBottom: 6 }}>Activer les sources inconnues</h3><p style={{ color: "#444", fontSize: 14, lineHeight: 1.6 }}>Paramètres → Ma Fire TV → Options développeur → Sources inconnues : Activé</p></div></div> <div style={{ background: "#FFDBFD", borderRadius: 14, padding: "20px 22px", border: "1px solid rgba(132,148,255,0.15)", display: "flex", gap: 16 }}><div style={{ flexShrink: 0, width: 40, height: 40, background: "#6367FF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, color: "#fff" }}>2</div><div><h3 style={{ fontWeight: 700, fontSize: 15, color: "#6367FF", marginBottom: 6 }}>Installer Downloader</h3><p style={{ color: "#444", fontSize: 14, lineHeight: 1.6 }}>Recherchez Downloader sur l'App Store Amazon et installez-le</p></div></div> <div style={{ background: "#FFDBFD", borderRadius: 14, padding: "20px 22px", border: "1px solid rgba(132,148,255,0.15)", display: "flex", gap: 16 }}><div style={{ flexShrink: 0, width: 40, height: 40, background: "#6367FF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, color: "#fff" }}>3</div><div><h3 style={{ fontWeight: 700, fontSize: 15, color: "#6367FF", marginBottom: 6 }}>Installer IPTV Smarters Pro</h3><p style={{ color: "#444", fontSize: 14, lineHeight: 1.6 }}>Via Downloader, téléchargez et installez l'APK IPTV Smarters Pro</p></div></div> <div style={{ background: "#FFDBFD", borderRadius: 14, padding: "20px 22px", border: "1px solid rgba(132,148,255,0.15)", display: "flex", gap: 16 }}><div style={{ flexShrink: 0, width: 40, height: 40, background: "#6367FF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, color: "#fff" }}>4</div><div><h3 style={{ fontWeight: 700, fontSize: 15, color: "#6367FF", marginBottom: 6 }}>Entrer vos identifiants Stream Bleu</h3><p style={{ color: "#444", fontSize: 14, lineHeight: 1.6 }}>Smarters → Ajouter utilisateur → collez votre URL M3U Stream Bleu</p></div></div> <div style={{ background: "#FFDBFD", borderRadius: 14, padding: "20px 22px", border: "1px solid rgba(132,148,255,0.15)", display: "flex", gap: 16 }}><div style={{ flexShrink: 0, width: 40, height: 40, background: "#6367FF", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 16, color: "#fff" }}>5</div><div><h3 style={{ fontWeight: 700, fontSize: 15, color: "#6367FF", marginBottom: 6 }}>Profitez de 25 000+ chaînes</h3><p style={{ color: "#444", fontSize: 14, lineHeight: 1.6 }}>Chargement terminé — naviguez dans toutes vos chaînes françaises en 4K</p></div></div>
          </div>
        </div>
      </section>
