...
export const metadata: Metadata = {
  ...
  description:
    "Comment regarder Stream Bleu sur Roku en France. Guide complet. 50 000+ chaînes, 4K Ultra HD. Compatible Roku Express 4K+, Roku Stick 4K, Roku Ultra.",
      ...
      <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "clamp(14px, 2vw, 17px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
            Guide complet pour configurer Stream Bleu sur votre Roku. Installation en 5 minutes, 50 000+ chaînes françaises et internationales en 4K Ultra HD.
          </p>
