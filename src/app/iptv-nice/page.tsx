...
export const metadata: Metadata = {
  title: { absolute: "IPTV Nice 2026 | Stream Bleu — Meilleur IPTV France" },
  description:
    "Stream Bleu est le meilleur service IPTV à Nice. Regardez TF1, Canal+, beIN Sports, RMC Sport et 25 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  keywords:
    "iptv nice, meilleur iptv nice, abonnement iptv Nice, iptv france Nice, stream bleu Nice",
  alternates: { canonical: "https://streambleu.fr/iptv-nice" },
  openGraph: {
    title: "IPTV Nice 2026 | Stream Bleu — Meilleur IPTV France",
    description:
      "Stream Bleu est le meilleur service IPTV à Nice. 25 000+ chaînes, 120 000+ films et séries en 4K. À partir de 9€/mois.",
    url: "https://streambleu.fr/iptv-nice",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Nice" }],
  },
...
const faqItems = [
  {
    q: "L'IPTV est-il légal à Nice ?",
    a: "La technologie IPTV est légale à Nice et dans toute la France. Stream Bleu diffuse des flux internet sur votre appareil. Les utilisateurs à Nice sont responsables de s'assurer que les contenus auxquels ils accèdent respectent la législation française sur le droit d'auteur.",
  },
  {
    q: "Quel est le meilleur service IPTV à Nice ?",
    a: "Stream Bleu est largement considéré comme le meilleur service IPTV à Nice. Il propose 25 000+ chaînes en direct incluant toutes les chaînes locales françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 120 000+ titres à la demande — à partir de 9€/mois.",
  },
  {
    q: "Stream Bleu fonctionne-t-il bien à Nice ?",
    a: "Oui. Stream Bleu fonctionne parfaitement à Nice avec n'importe quel fournisseur internet majeur comme Orange et SFR. Nos serveurs sont optimisés pour les connexions en Provence-Alpes-Côte d'Azur, offrant des streams 4K stables avec un minimum de buffering même aux heures de pointe.",
  },
  {
    q: "Combien coûte un abonnement IPTV à Nice ?",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV Nice 2026", "item": "https://streambleu.fr/iptv-nice"}
  ]
};
export default function IPTVNicePage() {
  return (
    <>
        ...
        <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <span style={{
              ...
              IPTV Nice · Stream Bleu
            </span>
            <h1 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.1, marginTop: 24, marginBottom: 20, color: "#5a5fcf" }}>
              Meilleur IPTV<br />
              <span style={{ color: "#5a5fcf" }}>Nice 2026</span>
            </h1>
            <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              Stream Bleu est le meilleur service IPTV à Nice. Profitez de TF1, Canal+, beIN Sports,
              RMC Sport et 25 000+ chaînes en 4K Ultra HD. Suivez l'OGC Nice, la Ligue 1 et les tournois de tennis sur toutes les chaînes sportives premium.
            </p>
        ...
        <section style={{ padding: "70px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 48, color: "#5a5fcf" }}>
              Pourquoi choisir Stream Bleu à Nice ?
            </h2>
        ...
        <section style={{ padding: "70px 16px", background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 40, color: "#5a5fcf" }}>
              Questions fréquentes — IPTV Nice
            </h2>
        ...
        <section style={{ padding: "60px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center" }}>
              ...
              ].filter(c => !c.href.includes("nice")).map((c) => (
