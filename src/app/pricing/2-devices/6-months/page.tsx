...
const productSchema = {
  ...
  description: "6 Months of IPTV access for 2 simultaneous connections. 25,000+ live channels in france including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
