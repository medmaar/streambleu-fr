...
export const metadata: Metadata = {
  title: { absolute: "IPTV sur PC Windows en France 2026 | Stream Bleu" },
  description:
    "Comment regarder Stream Bleu sur PC Windows en France. Guide complet. 50 000+ chaînes, 4K Ultra HD. Compatible Windows 10, Windows 11.",
  keywords: "iptv windows france, stream bleu pc windows, iptv pc windows france 2026",
  alternates: { canonical: "https://streambleu.fr/iptv-windows-france" },
  openGraph: {
    title: "IPTV sur PC Windows en France 2026 | Stream Bleu",
    description: "Installez Stream Bleu sur PC Windows en France. Guide étape par étape.",
    url: "https://streambleu.fr/iptv-windows-france",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV PC Windows" }],
  },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV sur PC Windows en France 2026", "item": "https://streambleu.fr/iptv-windows-france"}
  ]
};
export default function IPTVWindowsFrancePage() {
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "clamp(14px, 2vw, 17px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
            Guide complet pour configurer Stream Bleu sur votre PC Windows. Installation en 5 minutes, 50 000+ chaînes françaises et internationales en 4K Ultra HD.
          </p>
