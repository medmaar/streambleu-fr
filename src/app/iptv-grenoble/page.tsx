...
export const metadata: Metadata = {
  ...
  description:
    "Stream Bleu est le meilleur service IPTV à Grenoble. Regardez TF1, Canal+, beIN Sports, RMC Sport et 50 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  keywords:
    "iptv grenoble, meilleur iptv grenoble, abonnement iptv Grenoble, iptv france Grenoble, stream bleu Grenoble",
  alternates: { canonical: "https://streambleu.fr/iptv-grenoble" },
  openGraph: {
    title: "IPTV Grenoble 2026 | Stream Bleu — Meilleur IPTV Auvergne-Rhône-Alpes",
    description: "Stream Bleu est le meilleur service IPTV à Grenoble. 50 000+ chaînes, 300 000+ films et séries en 4K. À partir de 9€/mois.",
    url: "https://streambleu.fr/iptv-grenoble",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Grenoble" }],
  },
...
const faqItems = [
  {
    q: "L'IPTV est-il légal à Grenoble ?",
    a: "La technologie IPTV est légale à Grenoble et dans toute la France. Stream Bleu diffuse des flux internet sur votre appareil. Les utilisateurs à Grenoble sont responsables de s'assurer que les contenus auxquels ils accèdent respectent la législation française sur le droit d'auteur.",
  },
  {
    q: "Quel est le meilleur service IPTV à Grenoble ?",
    a: "Stream Bleu est le meilleur service IPTV à Grenoble. Il propose 50 000+ chaînes en direct incluant toutes les chaînes françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 300 000+ titres à la demande — à partir de 9€/mois.",
  },
  {
    q: "Stream Bleu fonctionne-t-il bien à Grenoble ?",
    a: "Oui. Stream Bleu fonctionne parfaitement à Grenoble avec tous les fournisseurs internet (Orange, SFR, Free, Bouygues). Nos serveurs sont optimisés pour les connexions en Auvergne-Rhône-Alpes, offrant des streams 4K stables même aux heures de pointe.",
  },
  {
    q: "Combien coûte un abonnement IPTV à Grenoble ?",
  ...
  {
    q: "Puis-je regarder le Grenoble Foot 38 en IPTV avec Stream Bleu ?",
    a: "Oui ! Stream Bleu inclut beIN Sports, RMC Sport et Canal+ Sport, ce qui vous permet de suivre le Grenoble Foot 38 et toutes les compétitions françaises et européennes en 4K Ultra HD.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "IPTV Grenoble 2026", item: "https://streambleu.fr/iptv-grenoble" },
  ],
};
    ...
    <>
      ...
      <main style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", color: "#1a1a4e", minHeight: "100vh" }}>
        ...
        <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <span style={{ background: "rgba(90,95,207,0.12)", border: "1px solid rgba(90,95,207,0.3)", color: "#5a5fcf", fontSize: 12, fontWeight: 700, padding: "4px 14px", borderRadius: 999, letterSpacing: "0.08em", textTransform: "uppercase" }}>
              IPTV Grenoble · Stream Bleu
            </span>
            <h1 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.1, marginTop: 24, marginBottom: 20, color: "#5a5fcf" }}>
              Meilleur IPTV<br /><span style={{ color: "#5a5fcf" }}>Grenoble 2026</span>
            </h1>
            <p style={{ fontSize: "clamp(15px, 2vw, 18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              Stream Bleu est le meilleur service IPTV à Grenoble. Profitez de TF1, Canal+, beIN Sports, RMC Sport et 50 000+ chaînes en 4K Ultra HD. Suivez le Grenoble Foot 38 et toutes les compétitions en 4K sans coupure.
            </p>
        ...
        <section style={{ padding: "70px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 48, color: "#5a5fcf" }}>Pourquoi choisir Stream Bleu à Grenoble ?</h2>
        ...
        <section style={{ padding: "48px 24px" }}>
          <div style={{ maxWidth: 720, margin: "0 auto", background: "#5a5fcf", borderRadius: 24, padding: "48px 40px", textAlign: "center", boxShadow: "0 12px 40px rgba(90,95,207,0.3)" }}>
            <h2 style={{ fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, color: "#fff", marginBottom: 16 }}>Abonnement IPTV Grenoble à partir de 9€/mois</h2>
        ...
        <section style={{ padding: "70px 16px", background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <h2 style={{ textAlign: "center", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 900, marginBottom: 40, color: "#5a5fcf" }}>Questions fréquentes — IPTV Grenoble</h2>
        ...
        <section style={{ padding: "60px 16px", background: "#fff" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center" }}>
              {allCities.filter(c => c.href !== "/iptv-grenoble").map((c) => (
