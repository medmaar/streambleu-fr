...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Apple TV" }],
  },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV sur Apple TV en France 2026", "item": "https://streambleu.fr/iptv-apple-tv-france"}
  ]
};
