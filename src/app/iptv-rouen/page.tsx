...
export const metadata: Metadata = {
  ...
  description: "Stream Bleu est le meilleur service IPTV à Rouen. Regardez TF1, Canal+, beIN Sports, RMC Sport et 25 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  ...
  openGraph: {
    ...
    description: "Stream Bleu est le meilleur service IPTV à Rouen. 25 000+ chaînes, 120 000+ films et séries en 4K. À partir de 9€/mois.",
...
const faqItems = [
  ...
  { q: "Quel est le meilleur service IPTV à Rouen ?", a: "Stream Bleu est le meilleur service IPTV à Rouen. Il propose 25 000+ chaînes en direct incluant toutes les chaînes françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 120 000+ titres à la demande — à partir de 9€/mois sans engagement." },
  ...
  { q: "Combien coûte un abonnement IPTV à Rouen ?", a: "Stream Bleu propose des abonnements à partir de 9€/mois sans engagement. Des forfaits longue durée permettent de descendre à 4€/mois. Toutes les formules incluent 25 000+ chaînes, 120 000+ films & séries, et les chaînes sportives premium." },
        ...
        <section style={{ padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "clamp(15px,2vw,18px)", color: "#5a5fcf", maxWidth: 640, marginBottom: 36, lineHeight: 1.7 }}>
              Stream Bleu est le meilleur service IPTV à Rouen. Profitez de TF1, Canal+, beIN Sports, RMC Sport et 25 000+ chaînes en 4K Ultra HD. Suivez le FC Rouen et toutes les compétitions en 4K sans coupure.
            </p>
