...
export const metadata: Metadata = {
  ...
  description:
    "Stream Bleu est le meilleur service IPTV à Toulouse. Regardez TF1, Canal+, beIN Sports, RMC Sport et 25 000+ chaînes en 4K. À partir de 9€. Essai gratuit disponible.",
  keywords:
  ...
  openGraph: {
    title: "IPTV Toulouse 2026 | Stream Bleu — Meilleur IPTV France",
    description:
      "Stream Bleu est le meilleur service IPTV à Toulouse. 25 000+ chaînes, 120 000+ films et séries en 4K. À partir de 9€/mois.",
    url: "https://streambleu.fr/iptv-toulouse",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Stream Bleu IPTV Toulouse" }],
  },
...
const faqItems = [
  {
    q: "L'IPTV est-il légal à Toulouse ?",
    a: "La technologie IPTV est légale à Toulouse et dans toute la France. Stream Bleu diffuse des flux internet sur votre appareil. Les utilisateurs à Toulouse sont responsables de s'assurer que les contenus auxquels ils accèdent respectent la législation française sur le droit d'auteur.",
  },
  {
    q: "Quel est le meilleur service IPTV à Toulouse ?",
    a: "Stream Bleu est largement considéré comme le meilleur service IPTV à Toulouse. Il propose 25 000+ chaînes en direct incluant toutes les chaînes locales françaises, les chaînes sportives premium (beIN Sports, RMC Sport, Canal+ Sport) et 120 000+ titres à la demande — à partir de 9€/mois.",
  },
  {
    q: "Stream Bleu fonctionne-t-il bien à Toulouse ?",
    a: "Oui. Stream Bleu fonctionne parfaitement à Toulouse avec n'importe quel fournisseur internet majeur comme Orange et Bouygues. Nos serveurs sont optimisés pour les connexions en Occitanie, offrant des streams 4K stables avec un minimum de buffering même aux heures de pointe.",
  },
  {
    q: "Combien coûte un abonnement IPTV à Toulouse ?",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV Toulouse 2026", "item": "https://streambleu.fr/iptv-toulouse"}
  ]
};
export default function IPTVToulousePage() {
  return (
    <>
        ...
        <section style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", padding: "80px 16px 60px" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, lineHeight: 1.1, marginTop: 24, marginBottom: 20, color: "#5a5fcf" }}>
              Meilleur IPTV<br />
              <span style={{ color: "#5a5fcf" }}>Toulouse 2026</span>
            </h1>
