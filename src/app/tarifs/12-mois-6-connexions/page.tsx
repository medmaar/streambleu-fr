...
export const metadata: Metadata = {
  ...
  description: "Abonnement IPTV 12 Mois pour 6 connexions simultanées à 294€. 50 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
