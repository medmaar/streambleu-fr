...
export const metadata: Metadata = {
  ...
  description: "Abonnement IPTV 1 Mois pour 5 connexions simultanées à 45€. 50 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
