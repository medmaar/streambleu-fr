...
export const metadata: Metadata = {
  title: { absolute: "9 Connections IPTV france 3 Months — €216 | Stream Bleu" },
  description:
    "Get 9 simultaneous connections for €216. 25 000+ live channels, 4K quality, Ligue 1, beIN Sports, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://streambleu.fr/pricing/9-devices/3-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Stream Bleu 3 Months IPTV Plan — 9 Devices",
  description: "3 Months of IPTV access for 9 simultaneous connections. 25 000+ live channels in france including Ligue 1, beIN Sports, CTV, RMC Sport and 120 000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://streambleu.fr/pricing/9-devices/3-months",
  },
};
