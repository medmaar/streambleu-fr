...
export const metadata: Metadata = {
  ...
  description: "Abonnement IPTV 1 Mois pour 3 connexions simultanées à 27€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Abonnement IPTV France 1 Mois 3 connexions" }],
  },
};
...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Non, aucun engagement. Le forfait 1 Mois 3 connexions est sans contrat — vous choisissez votre durée sans renouvellement automatique.",
  },
  {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV 1 Mois — 3 Connexions — 27€", "item": "https://streambleu.fr/tarifs/1-mois-3-connexions"}
  ]
};
          ...
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "28px 24px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 24, textAlign: "center" }}>
              ...
              <h1 style={{ fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 900, color: "#ffffff", lineHeight: 1.1, marginBottom: 16 }}>
                IPTV 1 Mois — 3 Connexions
              </h1>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "baseline", gap: 8, marginBottom: 12 }}>
                <span style={{ color: "#f5a623", fontWeight: 900, fontSize: "2.4rem" }}>Prix : 27€</span>
            ...
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "32px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 32 }}>
              ...
              <h2 style={{ color: "#ffffff", fontSize: "1.4rem", fontWeight: 800, marginBottom: 24 }}>
                Forfait IPTV 1 Mois — 3 Connexions
              </h2>
              <PlanOrderForm plan="Forfait IPTV 1 Mois — 3 Connexions" />
            </div>
