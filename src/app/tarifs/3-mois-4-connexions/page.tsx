...
export const metadata: Metadata = {
  ...
  description: "Abonnement IPTV 3 Mois pour 4 connexions simultanées à 116€. 50 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
