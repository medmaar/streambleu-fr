...
export const metadata: Metadata = {
  ...
  description: "Abonnement IPTV 6 Mois pour 10 connexions simultanées à 390€. 50 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
