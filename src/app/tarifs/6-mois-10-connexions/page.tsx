...
export const metadata: Metadata = {
  title: { absolute: "IPTV 6 Mois — 10 Connexions — 390€ | Stream Bleu" },
  description: "Abonnement IPTV 6 Mois pour 10 connexions simultanées à 390€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
  keywords: "iptv 10 connexions, abonnement iptv 6 mois 10 appareils, iptv 10 ecrans france",
  alternates: { canonical: "https://streambleu.fr/tarifs/6-mois-10-connexions" },
  openGraph: {
    title: "IPTV 6 Mois — 10 Connexions — 390€ | Stream Bleu",
    description: "Abonnement IPTV 6 Mois pour 10 connexions simultanées à 390€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
    url: "https://streambleu.fr/tarifs/6-mois-10-connexions",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Abonnement IPTV France 6 Mois 10 connexions" }],
  },
};
...
const productSchema = {
  ...
  "@type": "Product",
  name: "Stream Bleu IPTV 6 Mois — 10 Connexions",
  description: "Abonnement IPTV 6 Mois pour 10 connexions simultanées à 390€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
...
const faqItems: FaqItem[] = [
  {
    ...
    a: "Ce forfait supporte exactement 10 connexions simultanées. Tous vos 10 appareils peuvent regarder des chaînes différentes en même temps sur le même compte.",
  },
  {
  ...
  {
    q: "Quels appareils sont compatibles avec ce forfait 10 connexions ?",
  ...
  {
    q: "Y a-t-il un engagement avec ce forfait 6 Mois ?",
    a: "Non, aucun engagement. Le forfait 6 Mois 10 connexions est sans contrat — vous choisissez votre durée sans renouvellement automatique.",
  },
  {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV 6 Mois — 10 Connexions — 390€", "item": "https://streambleu.fr/tarifs/6-mois-10-connexions"}
  ]
};
          ...
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            ...
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "32px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 32 }}>
              ...
              <h2 style={{ color: "#ffffff", fontSize: "1.4rem", fontWeight: 800, marginBottom: 24 }}>
                Forfait IPTV 6 Mois — 10 Connexions
              </h2>
              <PlanOrderForm plan="Forfait IPTV 6 Mois — 10 Connexions" />
            </div>
            ...
            <div style={{ marginTop: 32, background: "rgba(90,95,207,0.06)", borderRadius: 16, padding: "24px 20px" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center" }}>
                <a href="/tarifs/1-mois-10-connexions" style={{ background: "rgba(90,95,207,0.1)", color: "#5a5fcf", borderRadius: 999, padding: "6px 16px", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>1 Mois — 90€</a>
                <a href="/tarifs/3-mois-10-connexions" style={{ background: "rgba(90,95,207,0.1)", color: "#5a5fcf", borderRadius: 999, padding: "6px 16px", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>3 Mois — 290€</a>
                <a href="/tarifs/6-mois-10-connexions" style={{ background: "rgba(90,95,207,0.1)", color: "#5a5fcf", borderRadius: 999, padding: "6px 16px", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>6 Mois — 390€</a>
                <a href="/tarifs/12-mois-10-connexions" style={{ background: "#5a5fcf", color: "#fff", borderRadius: 999, padding: "6px 16px", fontSize: 13, fontWeight: 700, textDecoration: "none" }}>12 Mois — 490€ ⭐</a>
