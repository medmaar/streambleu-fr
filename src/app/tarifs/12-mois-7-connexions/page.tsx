...
export const metadata: Metadata = {
  title: { absolute: "IPTV 12 Mois — 7 Connexions — 343€ | Stream Bleu" },
  description: "Abonnement IPTV 12 Mois pour 7 connexions simultanées à 343€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
  keywords: "iptv 7 connexions, abonnement iptv 12 mois 7 appareils, iptv 7 ecrans france",
  alternates: { canonical: "https://streambleu.fr/tarifs/12-mois-7-connexions" },
  openGraph: {
    title: "IPTV 12 Mois — 7 Connexions — 343€ | Stream Bleu",
    description: "Abonnement IPTV 12 Mois pour 7 connexions simultanées à 343€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
    url: "https://streambleu.fr/tarifs/12-mois-7-connexions",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Abonnement IPTV France 12 Mois 7 connexions" }],
  },
};
...
const productSchema = {
  ...
  "@type": "Product",
  name: "Stream Bleu IPTV 12 Mois — 7 Connexions",
  description: "Abonnement IPTV 12 Mois pour 7 connexions simultanées à 343€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Non, aucun engagement. Le forfait 12 Mois 7 connexions est sans contrat — vous choisissez votre durée sans renouvellement automatique.",
  },
  {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV 12 Mois — 7 Connexions — 343€", "item": "https://streambleu.fr/tarifs/12-mois-7-connexions"}
  ]
};
          ...
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "28px 24px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 24, textAlign: "center" }}>
              ...
              <h1 style={{ fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 900, color: "#ffffff", lineHeight: 1.1, marginBottom: 16 }}>
                IPTV 12 Mois — 7 Connexions
              </h1>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "baseline", gap: 8, marginBottom: 12 }}>
                <span style={{ color: "#f5a623", fontWeight: 900, fontSize: "2.4rem" }}>Prix : 343€</span>
            ...
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "32px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 32 }}>
              ...
              <h2 style={{ color: "#ffffff", fontSize: "1.4rem", fontWeight: 800, marginBottom: 24 }}>
                Forfait IPTV 12 Mois — 7 Connexions
              </h2>
              <PlanOrderForm plan="Forfait IPTV 12 Mois — 7 Connexions" />
            </div>
