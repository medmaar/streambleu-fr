...
export const metadata: Metadata = {
  title: { absolute: "IPTV 3 Mois — 2 Connexions — 58€ | Stream Bleu" },
  description: "Abonnement IPTV 3 Mois pour 2 connexions simultanées à 58€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
  keywords: "iptv 2 connexions, abonnement iptv 3 mois 2 appareils, iptv 2 ecrans france",
  alternates: { canonical: "https://streambleu.fr/tarifs/3-mois-2-connexions" },
  openGraph: {
    title: "IPTV 3 Mois — 2 Connexions — 58€ | Stream Bleu",
    description: "Abonnement IPTV 3 Mois pour 2 connexions simultanées à 58€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
    url: "https://streambleu.fr/tarifs/3-mois-2-connexions",
    type: "website",
    siteName: "Stream Bleu",
    locale: "fr_FR",
    images: [{ url: "/abonnement-iptv-france-1.jpg", width: 800, height: 533, alt: "Abonnement IPTV France 3 Mois 2 connexions" }],
  },
};
...
const productSchema = {
  ...
  "@type": "Product",
  name: "Stream Bleu IPTV 3 Mois — 2 Connexions",
  description: "Abonnement IPTV 3 Mois pour 2 connexions simultanées à 58€. 25 000+ chaînes françaises, beIN Sports, Canal+, 4K Ultra HD H.265. Sans engagement. Identifiants en 5 min.",
...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Non, aucun engagement. Le forfait 3 Mois 2 connexions est sans contrat — vous choisissez votre durée sans renouvellement automatique.",
  },
  {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "IPTV 3 Mois — 2 Connexions — 58€", "item": "https://streambleu.fr/tarifs/3-mois-2-connexions"}
  ]
};
          ...
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            ...
            <div style={{ background: "#5a5fcf", borderRadius: 24, padding: "32px", boxShadow: "0 8px 32px rgba(90,95,207,0.25)", marginBottom: 32 }}>
              ...
              <h2 style={{ color: "#ffffff", fontSize: "1.4rem", fontWeight: 800, marginBottom: 24 }}>
                Forfait IPTV 3 Mois — 2 Connexions
              </h2>
              <PlanOrderForm plan="Forfait IPTV 3 Mois — 2 Connexions" />
            </div>
