...
export const metadata: Metadata = {
  title: { absolute: "6 Connections IPTV france 1 Month — €54 | Stream Bleu" },
  description:
    "Get 6 simultaneous connections for €54. 25 000+ live channels, 4K quality, Ligue 1, beIN Sports, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://streambleu.fr/pricing/6-devices/1-month" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Stream Bleu 1 Month IPTV Plan — 6 Devices",
  description: "1 Month of IPTV access for 6 simultaneous connections. 25 000+ live channels in france including Ligue 1, beIN Sports, CTV, RMC Sport and 120 000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://streambleu.fr/pricing/6-devices/1-month",
  },
};
