...
export const metadata: Metadata = {
  title: { absolute: "6 Connections IPTV france 6 Months — €210 | Stream Bleu" },
  description:
    "Get 6 simultaneous connections for €210. 25 000+ live channels, 4K quality, Ligue 1, beIN Sports, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://streambleu.fr/pricing/6-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Stream Bleu 6 Months IPTV Plan — 6 Devices",
  description: "6 Months of IPTV access for 6 simultaneous connections. 25 000+ live channels in france including Ligue 1, beIN Sports, CTV, RMC Sport and 120 000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://streambleu.fr/pricing/6-devices/6-months",
  },
};
