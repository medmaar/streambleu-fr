    ...
    <main style={{ background: "linear-gradient(to right, rgba(100,130,255,0.08) 0%, #c5bcf5 30%, #fdf5ff 60%, rgba(220,100,120,0.07) 100%)", color: "#1a1a4e", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "60px 16px", textAlign: "center", background: "#5a5fcf" }}>
        <div style={{ maxWidth: 620, margin: "0 auto" }}>
          ...
          <Link href="/essai-gratuit" style={{ display: "inline-block", background: "#5a5fcf", color: "#fff", padding: "14px 36px", borderRadius: 14, fontWeight: 700, fontSize: 16, textDecoration: "none", boxShadow: "0 6px 20px rgba(90,95,207,0.4)" }}>
            Essai Gratuit 24h
          </Link>
        </div>
      </section>
      ...
      <section style={{ padding: "48px 16px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <p style={{ textAlign: "center", color: "#1a1a4e", fontSize: 13, fontWeight: 600, marginBottom: 20 }}>
